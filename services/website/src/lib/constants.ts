...
// published desktop/v0.1.0 release on GitHub.
const DL = `${GITHUB}/releases/download/desktop/v0.1.0`

export const DOWNLOAD_LINKS = {
  macos_arm: {
    url: `${DL}/Maestra_0.1.0_aarch64.dmg`,
    label: 'macOS',
    arch: 'Apple Silicon (.dmg)',
    icon: 'Apple' as const,
  },
  macos_intel: {
    url: `${DL}/Maestra_0.1.0_x64.dmg`,
    label: 'macOS',
    arch: 'Intel (.dmg)',
    icon: 'Apple' as const,
  },
  windows: {
    url: `${DL}/Maestra_0.1.0_x64_en-US.msi`,
    label: 'Windows',
    arch: 'x64 (.msi)',
    icon: 'Monitor' as const,
  },
  linux: {
    url: `${DL}/Maestra_0.1.0_amd64.AppImage`,
    label: 'Linux',
